...
public let yy_appdelegate = UIApplication.shared.delegate
public let yy_appdelegate_window = yy_appdelegate?.window
public var yy_appdelegate_rootVC = yy_appdelegate_window??.rootViewController
